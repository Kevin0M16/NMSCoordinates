...
namespace NMSCoordinates
{
    ...
    {
        public static bool CoordinateOutOfRange(string GalacticCoord)
        {
            ...
            if (GalacticCoord.Contains(":") && GalacticCoord.Length == 19)
            {
                ...
                bool isOutOfRange = Convert.ToInt32(A, 16) > 4096 || Convert.ToInt32(B, 16) > 255 || Convert.ToInt32(C, 16) > 4096 || Convert.ToInt32(D, 16) > 767;
                return isOutOfRange;
            }
        ...
        private static void CalculateLongHex(string hx, out string GalacticCoord2, out int Planet, out int galdec, TextBox tb = null)
        {
        ...
        private static void HexToVoxel(string basehx, TextBox tb = null)
        {
            //PlanetNumber--SolarSystemIndex--GalaxyNumber--VoxelY--VoxelZ--VoxelX
            //4 bit--12 bit--8 bit--8 bit--12 bit--12 bit
        ...
        public static string VoxelToHex(int gal, int P, int X, int Y, int Z, int SSI, TextBox tb = null)
        {
            //PlanetNumber--SolarSystemIndex--GalaxyNumber--VoxelY--VoxelZ--VoxelX
            //4 bit--12 bit--8 bit--8 bit--12 bit--12 bit
            //"0x2 049 00 01 D37 652" 460 475 89 64 091 954   0 04A FB 9F6 C9D
            ...
            Globals.AppendLine(tb, "Galactic HEX to DEC: " + dec1.ToString() + " " + dec2.ToString() + " " + dec3.ToString());
            ...
            Globals.AppendLine(tb, "Calculate Portal DEC: " + "X:" + calc1.ToString() + " Y:" + calc2.ToString() + " Z:" + calc3.ToString());
        ...
        public static string GalacticToPortal(int Planet, string X, string Y, string Z, string SSI, TextBox tb = null)
        {
        ...
        public static string VoxelToPortal(int P, int X, int Y, int Z, int SSI, TextBox tb = null)
        {
        ...
        private static void PortalToVoxel(string portalcode, TextBox tb = null)
        {
            //0 04A FB 9F6 C9D
            //Break apart Portal Code
            string b6 = portalcode.Substring(portalcode.Length - 3, 3);
        ...
        public static string VoxelToGalacticCoord(int X, int Y, int Z, int SSI, TextBox tb = null)
        {
        ...
        private static void GalacticToVoxel(string X, string Y, string Z, string SSI, out int iX, out int iY, out int iZ, out int iSSI, TextBox tb = null)
        {
        ...
        private static void GalacticToVoxel(string X, string Y, string Z, string SSI, TextBox tb = null)
        {
            //Galactic Coordinate to Voxel Coordinates 
            tb?.Clear();
